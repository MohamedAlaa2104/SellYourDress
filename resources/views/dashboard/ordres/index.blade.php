                    ...
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="products-table">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0">@lang('dashboard.type')</th>
    ...
    <script>
        $('#products-table').DataTable({
            ...
            columns: [
                ...
                {data: 'type', name:'type'},
                {data: 'product.name_{{LaravelLocalization::getCurrentLocale()}}', name:'product.name_{{LaravelLocalization::getCurrentLocale()}}'},
                {data: 'product.category.name_{{LaravelLocalization::getCurrentLocale()}}', name:'product.category.name_{{LaravelLocalization::getCurrentLocale()}}'},
                {data: 'img', name:'img'},
