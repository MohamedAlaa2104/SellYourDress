                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('dashboard.products.store')}}" class="form-horizontal" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="description_en" class="form-control" id="inputName" required>{{old('description')}}</textarea>
                        </div>
                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.description_ar')</p>
                            <textarea type="text" name="description_ar" class="form-control" id="inputName" required>{{old('description')}}</textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                <label class="rdiobox"><input name="sell_type" value="0" type="radio"><span>@lang('dashboard.rent')</span></label>
                            </div>
                            <div class="col-lg-3">
                                <label class="rdiobox"><input name="sell_type" value="1" type="radio"><span>@lang('dashboard.sell')</span></label>
                            </div>
                            <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                                <label class="rdiobox"><input name="sell_type" value="2" type="radio"><span>@lang('dashboard.sell_and_rent')</span></label>
                            </div>
                        </div>
                        ...
                        <div class="main-toggle-group-demo mg-t-20 mg-b-20">
                            ...
                            <div id="featured-switch" class="main-toggle main-toggle-success ">
                                <span></span>
                            </div>
                        </div>
                        <div class="mg-b-20">
